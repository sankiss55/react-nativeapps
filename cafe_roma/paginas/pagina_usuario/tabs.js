...
import Usuario2 from "./productos_all";
  ...
  return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="Stack_productos" component={Stack_productos} />
          <Stack.Screen name="Carrito2" component={Carrito2} />
          
          <Stack.Screen name="Usuario2" component={Usuario2} />
      </Stack.Navigator>
  );
}
...
const styles = StyleSheet.create({
  ...
  badgeText: {
   ...
   iconContainer: {
    ...
    padding: 12,
    borderRadius: 50,
    elevation: 6, // para sombra Android
    shadowColor: '#000',
